...
xgb_params['learning_rate'] = st.sidebar.selectbox("Learning Rate", [0.01, 0.1, 0.2], index=1, format="%.2f")
xgb_params['n_estimators'] = st.sidebar.selectbox("Number of Estimators", [50, 100, 200], index=1, format="%d")
xgb_params['max_depth'] = st.sidebar.selectbox("Max Depth", [3, 5, 7], index=1, format="%d")
...
xgb_params['random_state'] = st.sidebar.selectbox("Random State", [42, 123, 456], index=0, format="%d")
